...
namespace Trein.ViewModel
{
    ...
    public class ReisadviesViewModel : CustomViewModelBase
    {
        ...
        public string PageName
        {
            get
            {
                return _resourceLoader.GetString("reisadvies");
            }
        }
        ...
        {
          NavigationService.NavigateToReisadvies(x);
        ...
        private void GoPrijs()
        {
            if (SelectedSearch != null)
            {
                NavigationService.NavigateToPrijs(SelectedSearch.Id);
            }
        }
        ...
        private void GoVertrektijden()
        {
            if (SelectedSearch != null)
            {
                ...
                NavigationService.NavigateToStationTijden(from);
            }
        }
        ...
        private void PlanTerugreis()
        {
            if (SelectedSearch != null)
            {
              ...
              if(SelectedReisMogelijkheid != null)
                ...
                NavigationService.NavigateToPlanner(string.Format("from={0}&to={1}&via={2}&dateTime={3}", to, from, via, dateTime));
            }
        }
        ...
        private void RepeatSearch(PlannerSearch search)
        {
            ...
            NavigationService.NavigateToPlanner(string.Format("/Views/Planner.xaml?from={0}&to={1}&via={2}", from, to, via));
        }
