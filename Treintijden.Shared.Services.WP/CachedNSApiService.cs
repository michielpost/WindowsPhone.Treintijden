...
namespace Treintijden.Shared.Services.WP
{
	public class CachedNSApiService : INSApiService
	{
		...
		public Task<TreinInfo> GetTreinInfo(string treinnummer)
		{
			string cacheKey = "GetTreinInfo_" + treinnummer;

			return DataCache.GetAsync(cacheKey, () => Original.GetTreinInfo(treinnummer), DateTime.Now.Date.AddDays(1));
		}
	}
}
